...
{
    /// <summary>
    /// Defines the <see cref="Enums" />.
    /// </summary>
    public class Enums
    {
        /// <summary>
        /// Defines the <see cref="FormatType" />.
        /// </summary>
        ...
        /// <summary>
        /// Defines the <see cref="FormatModel" />.
        /// </summary>
        ...
        /// <summary>
        /// Defines the <see cref="RegexDefine" />.
        /// </summary>
        public struct RegexDefine
        {
            ...
            public const string IntergerAm = @"^((\-\d+)|(\d*))$";
            ...
            // Nếu không có default password tức là áp dụng các ràng buộc mật khẩu
            // 8-> 15 ký tự
            // Có ít nhất 1 ký tự thường
            // Có ít nhất 1 ký tự HOA
            // Có ít nhất 1 ký tự đặc biệt
            // Có ít nhất 1 ký tự số
            public const string Password = @"^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z])\S{8,15}$";
